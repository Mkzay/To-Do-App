...
export default function Head({ handleClick }) {
  return (
    <div className="flex items-center justify-center bg-[url('images/bg-mobile-light.jpg')] dark:bg-[url('images/bg-mobile-dark.jpg')] bg-no-repeat bg-cover w-full h-[250px]">
